...
'Convective Outlook Hazard':'conhazo',
...
'Probability of a Tropical Wind Speed above 34 knots (Cumulative)':'tcwspdabv34c',
'Probability of a Tropical Wind Speed above 34 knots (Incremental)':'tcwspdabv34i',
'Probability of a Tropical Wind Speed above 50 knots (Cumulative)':'tcwspdabv50c',
'Probability of a Tropical Wind Speed above 50 knots (Incremental)':'tcwspdabv50i',
'Probability of a Tropical Wind Speed above 64 knots (Cumulative)':'tcwspdabv64c',
'Probability of a Tropical Wind Speed above 64 knots (Incremental)':'tcwspdabv64i',
...
def ndfdDefs():
    return { 'vars': NDFD_VARS, 'wx': WX_VARS, 'wwa': WWA_VARS, 'grids': GRID_VARS, 'files': VARS_TO_FILE }
